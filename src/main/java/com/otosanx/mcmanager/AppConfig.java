...
public class AppConfig {
    ...
    public boolean quickActionsCollapsed = false;
    public boolean consoleCollapsed = false;
    public boolean performanceCollapsed = false;
    public boolean commandCollapsed = false;
    public String layoutTopLeftSection = "SERVER_SETTINGS";
    public String layoutTopRightSection = "QUICK_ACTIONS";
    public String layoutBottomLeftSection = "LIVE_CONSOLE";
    public String layoutBottomRightSection = "PERFORMANCE_MONITOR";
    public int layoutTopDivider = 620;
    public int layoutBottomDivider = 620;
    public int layoutVerticalDivider = 300;
    public String compactPrioritySection = "SERVER_SETTINGS";
